...
export function MagicCard(props) {
	...
	const glowFrom =
		isOrbMode(props) ? (props.glowFrom ?? "#ee4f27") : "#ee4f27";
	const glowTo = isOrbMode(props) ? (props.glowTo ?? "#6b21ef") : "#46ecd5";
	...
	return (
		<motion.div
			className={cn(
				"group relative isolate overflow-hidden rounded-[inherit] border-2 border-transparent",
				className,
			)}
